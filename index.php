    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <form class="form-group row" method="get" action="">
            ...
            <?php 
                ...
                while ($dt = mysqli_fetch_assoc($query)) {
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="hapus_data.php?nomor_surat=<?php echo $dt['nomor_surat'];?>" onclick="return confirm('Apakah Anda yakin ingin menghapus arsip surat ini?');" class="btn btn-primary"> Hapus </a>  
                    <a href="berkas/<?php echo $dt['file'];?> "download="<?php echo $dt['file'];?>" class="btn btn-success"> Unduh </a>
                    <a href="lihat_data.php?nomor_surat=<?php echo $dt['nomor_surat'] ?>" class="btn btn-danger"> Lihat </a>
                    </td>
                  </tr>
          ...
          <br>
          <a href="tambah_data.php" class="btn btn-secondary"> Arsipkan Surat </a>
        </div>
        <!-- /.card-body -->
